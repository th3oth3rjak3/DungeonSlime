...
public class Tileset
{
	...
	/// <param name="tileWidth">The width of each tile in the tileset, in pixels.
	/// <param name="tileHeight">The height of each tile in the tileset, in pixels.</param>
	...
	/// </summary>
	/// <param name="index">The index of the texture region in this tileset.</param>
	...
	/// <summary>
	/// Gets the texture region for the tile from this tileset at the given column and row.
	/// </summary>
	/// <param name="column">The column in this tileset of the texture region (0-based)</param>
	/// <param name="row">The row in this tileset of the texture region (0-based)</param>
	/// <returns>The texture region for the tile from this tileset at the given column and row.</returns>
