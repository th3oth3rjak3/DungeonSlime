...
public class TitleScene : Scene
{
    ...
    public override void Initialize()
    {
        ...
        ArgumentNullException.ThrowIfNull(_font5x);
    ...
    {
        // Load the font for the standard text globally.
        _font = Core.Content.Load<SpriteFont>("fonts/04B_30");

        // Load the font for the title text in the current scene only.
    ...
    {
        ArgumentNullException.ThrowIfNull(_backgroundPattern);
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        if (_titleScreenButtonsPanel is not null && _titleScreenButtonsPanel.IsVisible)
        {
    ...
    {
        ArgumentNullException.ThrowIfNull(_uiSoundEffect);
    ...
    {
        ArgumentNullException.ThrowIfNull(_uiSoundEffect);
        ArgumentNullException.ThrowIfNull(_titleScreenButtonsPanel);
        ArgumentNullException.ThrowIfNull(_optionsPanel);
        ArgumentNullException.ThrowIfNull(_optionsBackButton);
    ...
    private void HandleOptionsButtonBack(object? sender, EventArgs e)
    {
        ...
        ArgumentNullException.ThrowIfNull(_titleScreenButtonsPanel);
        ArgumentNullException.ThrowIfNull(_optionsPanel);
        ArgumentNullException.ThrowIfNull(_optionsButton);
